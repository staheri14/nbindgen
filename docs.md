...
TODO: update these docs - we're generating Nim code now!
...
# A list of modules  #include (avoid)
# default: []
includes = ["my_great_lib"]

# Whether nbindgen's default standard imports should be suppressed. These
# imports are included by default because our generated headers tend to require
# them. Currently, the generated imports are:
#
# default: false
no_includes = false
